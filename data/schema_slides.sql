...
('perdon', 'Perdón', 'Acto penitencial / bendición del agua', 3, 0),
('gloria', 'Gloria', 'Canción del Gloria o texto fijo', 4, 1),
('transicion_palabra', 'Transición Palabra', 'Separador antes de la Liturgia de la Palabra', 5, 0),
('primera_lectura', 'Primera Lectura', 'Primera lectura bíblica', 6, 0),
('salmo', 'Salmo', 'Salmo responsorial', 7, 0),
('segunda_lectura', 'Segunda Lectura', 'Segunda lectura bíblica', 8, 0),
('aleluya', 'Aleluya', 'Canto de aleluya', 9, 1),
('evangelio', 'Evangelio', 'Evangelio del día', 10, 0),
('transicion_eucaristia', 'Transición Eucaristía', 'Separador antes de la Liturgia Eucarística', 11, 0),
('credo', 'Credo', 'Credo de la asamblea', 12, 0),
('ofertorio', 'Ofertorio', 'Canción de ofertorio', 13, 1),
('santo', 'Santo', 'Santo / Prefacio', 14, 1),
('padre_nuestro', 'Padre Nuestro', 'Oración del Señor', 15, 1),
('paz', 'Paz', 'Rito de la paz', 16, 1),
('comunion', 'Comunión', 'Canción de comunión', 17, 1),
('maria', 'Canto a María', 'Canto a la Virgen', 18, 1),
('despedida', 'Despedida', 'Canción de despedida / ¡Id en paz!', 19, 1);
