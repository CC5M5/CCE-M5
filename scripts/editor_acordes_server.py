...
<head>
  ...
  <style>
    ...
    .cancion-con-acordes {{ font-family: ui-monospace, "SF Mono", "Cascadia Mono", "Segoe UI Mono", "Roboto Mono", Menlo, Consolas, "Courier New", monospace; line-height: 0.35; white-space: pre; }}
